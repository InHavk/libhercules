...
void test_event_with_container(void){
    ...
    container_add_tag_Byte(event->payload, 4, "byte", 55);
    // direct check
    ...
    container_add_tag_Short(event->payload, 5, "short", 1024);
    // direct check
    ...
    container_add_tag_Integer(event->payload, 7, "integer", 1048576);
    // direct check
    ...
    container_add_tag_Long(event->payload, 4, "long", 274877906944);
    // direct check
    ...
    container_add_tag_Flag(event->payload, 4, "flag", 1);
    // direct check
    ...
    container_add_tag_Float(event->payload, 5, "float", 32.0f);
    // direct check
    ...
    container_add_tag_Double(event->payload, 6, "double", 64.0);
    // direct check
    ...
    container_add_tag_String(event->payload, 6, "string", "test string");
    // direct check
    ...
    container_add_tag_UUID(event->payload, 4, "uuid", uuid_value);
    // direct check
    ...
    container_add_tag_Null(event->payload, 4, "null");
    // direct check
    TEST_ASSERT_EQUAL_INT8(4, ((Tag*) (list_get_latest(event->payload)->value))->key.length);
    ...
    TEST_ASSERT_NOT_NULL(tag10->value);
    ...
    container_add_tag_Vector(event->payload, NULL_TYPE, 6, "vector");
    // direct check
    ...
    container_add_tag_Container(event->payload, 9, "container");
    // direct check
